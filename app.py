...
def index():
    ...
    if request.method == "POST":
        ...
        output = model.predict([[creditScore, age, tenure, balance, numOfProducts, hasCrCard, isActiveMember, estimatedSalary, germany, spain, gender]]),
        # print(creditScore, age, tenure, balance, numOfProducts, hasCrCard, isActiveMember, germany, spain, gender)
        # make prediction
        print(output[0][0])
        return "will leave company" if output[0][0]==1 else "will not leave company"
